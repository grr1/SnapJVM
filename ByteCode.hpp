...
/* Derived from OpenJDK hotspot/share/interpreter/bytecodes.hpp */
...
class ByteCode {
 public:
  ...
  static u1 			_depth         [number_of_codes];
  static u1            _lengths       [number_of_codes];
  static Code          _java_code     [number_of_codes];
  static u2         	_flags         [(1<<8)*2]; // all second page for wide formats
